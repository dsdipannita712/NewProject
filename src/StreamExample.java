...
//        list.add(new EmployeeDetails(123,"dipa",78,"F","kolkata","CSE"));
//        list.add(new EmployeeDetails(456,"mou",67,"M","delhi","Mechnical"));
//        list.add(new EmployeeDetails(989,"mou",88,"F","kolkata","CSE"));
//        list.add(new EmployeeDetails(321,"adrija",76,"F","Bangalore","Civil"));
//        list.add(new EmployeeDetails(128,"subharaj",43,"M","delhi","CSE"));
//        list.add(new EmployeeDetails(765,"sanku",23,"M","Bangalore","Civil"));
